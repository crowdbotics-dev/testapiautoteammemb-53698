...
## Project Structure
    ...
    ├── testapiautoteammemb_53698  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_53698`
...
2. Clone this repo and `cd testapiautoteammemb_53698`
